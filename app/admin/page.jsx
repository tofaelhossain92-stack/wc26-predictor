...
export default function AdminPage() {
  ...
  async function toggleChatbot() {
    ...
    const data = await res.json()
    setMessage({ type: 'success', text: data.enabled ? '✅ Kicktionary enabled' : '⛔ Kicktionary disabled' })
  }
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            <button onClick={toggleChatbot}  style={{ padding: '8px 14px', borderRadius: 10, border: '1px solid rgba(74,158,255,0.4)', background: 'rgba(74,158,255,0.1)', color: '#4a9eff', fontWeight: 700, fontSize: 12, cursor: 'pointer' }}>📊 Toggle Kicktionary</button>
